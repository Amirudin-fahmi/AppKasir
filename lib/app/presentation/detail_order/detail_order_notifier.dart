...
import 'package:parfumhana_kasir/core/constant/constant.dart';
...
import 'package:parfumhana_kasir/core/helper/shared_preferences_helper.dart';
...
class DetailOrderNotifier extends AppProvider {
  ...
  print() async {
    ...
    if (printerSave.isNotEmpty) {
      ...
      snackBarMessage = 'Anda belum menyeting printer';
    }
    ...
    _order!.items.forEach(
      (element) {
        ...
        bytes += ticket.row([
          ...
          PosColumn(
              text: NumberHelper.formatNumber(element.price, '#,###'),
              width: 3,
